...
import type { GuessTheImposterGame, GuessTheImposterGameConfig } from './types';

interface GameSelectionProps {
  onStartGame: (gameConfig: GuessTheImposterGameConfig) => void;
  playerCount: number;
  isHost: boolean;
}
...
export function GameSelection({ onStartGame, playerCount, isHost }: GameSelectionProps) {
  const [selectedCategory, setSelectedCategory] = useState<GuessTheImposterGame['category'] | null>(null);
